...
function SupervisionEntries() {
  ...
  const cols: GridColDef[] = [
    ...
    },{field: 'organisation', headerName: 'Организация', width: 200, editable: true},
    {field: 'controlArea', headerName: 'Область контроля', width: 200, editable: true},
    {field: 'plannedDate', headerName: 'План', width: 200, editable: true},
    {field: 'actualDate', headerName: 'Факт', width: 200, editable: true},
    {field: 'supervisorName', headerName: 'ФИО супервайзера', width: 200, editable: true},
    {
    ...
    {field: 'documentNumber', headerName: '№ документа', width: 200, editable: true},
    {field: 'supervisionDate', headerName: 'Дата', width: 200, editable: true},
    {field: 'description', headerName: 'Описание', width: 200, editable: true},
    {field: 'annotations', headerName: 'Примечание', width: 200, editable: true},
  ];
...
export function SupervisionPage() {
  ...
  const {data, error, isLoading} = useSWR<ISupervision>(endpoint, getData)
  ...
  return <SupervisionContext.Provider value={state}>
    <Stack p={'3rem'} spacing={'1.5rem'}>
      <Heading title={'Надзор'} endpoint={endpoint} context={SupervisionContext}
               status={<CustomChip
