...
export function MilestonesPage() {
  ...
  const {data, error, isLoading} = useSWR<IMilestones>(endpoint, getData)
  ...
  return <MilestonesContext.Provider value={state}>
    <Stack p={'3rem'} spacing={'1.5rem'}>
      <Heading title={'Вехи'} endpoint={endpoint} context={MilestonesContext}
               status={<CustomChip
