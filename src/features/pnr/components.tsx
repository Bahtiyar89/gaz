...
import { getPnr } from "~/common/utils/rest-utils";
    ...
    <Paper>
      <Stack p={"1rem"} spacing={"1rem"}>
        ...
        <StyledDatePicker
          ...
          onChange={(date) => {
            if (date)
              state!.technologicalEnvironment.plannedDate = dateFormat(date);
          }}
          label={"План"}
        />
        ...
        <StyledDatePicker
          ...
          onChange={(date) => {
            if (date)
              state!.technologicalEnvironment.actualDate = dateFormat(date);
          }}
          label={"Факт"}
        />
        {/*</Stack>*/}
    ...
    <Stack spacing={"0.5rem"}>
      ...
      >
        ...
        <Box width={"5rem"}>
          <LinearProgress
            variant="determinate"
            value={(props.actualValue / props.plannedValue) * 100}
          />
        </Box>
      </Stack>
      ...
      <Stack p={"1rem"} spacing={"1rem"}>
        ...
        <InputsWithProgress
          ...
          onPlannedChange={(event) =>
            (state!.systems.pnrPresented.planned = parseInt(event.target.value))
          }
          actualValue={systems.pnrPresented.actual}
          onActualChange={(event) =>
            (state!.systems.pnrPresented.actual = parseInt(event.target.value))
          }
        />
        ...
        <InputsWithProgress
          ...
          onPlannedChange={(event) =>
            (state!.systems.pnrAccepted.planned = parseInt(event.target.value))
          }
          actualValue={systems.pnrAccepted.actual}
          onActualChange={(event) =>
            (state!.systems.pnrAccepted.actual = parseInt(event.target.value))
          }
        />
        ...
        <InputsWithProgress
          ...
          onPlannedChange={(event) =>
            (state!.systems.pnrOngoing.planned = parseInt(event.target.value))
          }
          actualValue={systems.pnrOngoing.actual}
          onActualChange={(event) =>
            (state!.systems.pnrOngoing.actual = parseInt(event.target.value))
          }
        />
        ...
        <InputsWithProgress
          ...
          onPlannedChange={(event) =>
            (state!.systems.pnrFinished.planned = parseInt(event.target.value))
          }
          actualValue={systems.pnrFinished.actual}
          onActualChange={(event) =>
            (state!.systems.pnrFinished.actual = parseInt(event.target.value))
          }
        />
      </Stack>
    </Paper>
    ...
    <Paper sx={{ height: "100%" }}>
      <Stack p={"1rem"} spacing={"1rem"}>
        ...
        <InputsWithProgress
          ...
          onPlannedChange={(event) =>
            (state!.acts.individualTests.planned = parseInt(event.target.value))
          }
          actualValue={acts.individualTests.actual}
          onActualChange={(event) =>
            (state!.acts.individualTests.actual = parseInt(event.target.value))
          }
        />
        ...
        <InputsWithProgress
          ...
          onPlannedChange={(event) =>
            (state!.acts.complexTesting.planned = parseInt(event.target.value))
          }
          actualValue={acts.complexTesting.actual}
          onActualChange={(event) =>
            (state!.acts.complexTesting.actual = parseInt(event.target.value))
          }
        />
      </Stack>
    </Paper>
    ...
    <Paper sx={{ height: "100%" }}>
      <Stack p={"1rem"} spacing={"1rem"}>
        ...
        <InputWithProgress
          ...
          onChange={(event) => {
            state!.keySystems.signedIndividualTests = parseInt(
              event.target.value
            );
          }}
        />
...
export function PnrPage() {
  ...
  const { data, error, isLoading } = useSWR<any>(endpoint, getPnr);
  ...
  return (
    <PnrContext.Provider value={state}>
