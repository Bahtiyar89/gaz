...
function BudgetEntries() {
  ...
  const columnGroups = [
    {
      groupId: 'ЛКВ',
      children: [{field: 'lkvPlan1'}, {field: 'lkvPlan2'}, {field: 'lkvPlan3'}, {field: 'lkvActual'}, {field: 'lkvActualForecast'}],
    },
    {
    ...
    },
    {
      ...
      children: [{field: 'currentYearProgram'}, {field: 'futureYearsProgram'}]
    },
    {
    ...
    },
    {
      ...
      children: [{field: 'oksGeneralContract'}, {field: 'oksDevelopment'}, {field: 'oksYear'}]
    },
  ]
  ...
  const cols: GridColDef[] = [
    ...
    {field: 'lkvActualForecast', headerName: 'Факт прогноз', width: 200, editable: true},
    {
      field: 'primaryPlan',
    ...
    {field: 'creditDebt', headerName: 'Кредиторская задолженность', width: 200, editable: true},
    {field: 'debitDebt', headerName: 'Дебиторская задолженность', width: 200, editable: true},
    {field: 'repayment', headerName: 'Погашение кредиторской', width: 200, editable: true},
    {field: 'financingSum', headerName: 'Сумма финансирования', width: 200, editable: true},
    {field: 'currentYearProgram', headerName: 'Программа текущего года', width: 200, editable: true},
    {field: 'futureYearsProgram', headerName: 'Программа будущих лет', width: 200, editable: true},
    {field: 'financingPlan', headerName: 'План', width: 200, editable: true},
    {field: 'financingActual', headerName: 'Факт', width: 200, editable: true},
    {field: 'oksYear', headerName: 'Год', width: 200, editable: true},
    {field: 'oksGeneralContract', headerName: 'Генподряд', width: 200, editable: true},
    {field: 'oksDevelopment', headerName: 'Освоение', width: 200, editable: true},
  ];
...
export function BudgetPage() {
  ...
  const {data, error, isLoading} = useSWR<IBudget>(endpoint, getData)
  ...
  return <BudgetContext.Provider value={state}>
    <Stack p={'3rem'} spacing={'1.5rem'}>
      <Heading title={'Бюджет'} endpoint={endpoint} context={BudgetContext} status={
        <CustomChip
